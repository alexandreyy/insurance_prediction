...
def plot_roc(mean_fpr, mean_tpr, mean_auc):
    ...
    plt.savefig("../../results/ANN/roc.png", bbox_inches = 'tight')
...
if __name__ == '__main__':
    ...
    data = Data()
    data.validation_x = homesite.validation_x
    data.validation_y = homesite.validation_y
    ...
    for i, (train, test) in enumerate(cvs):
        ...
        save_np_array("../../results/ANN/ann_accuracy_" + str(c) + ".bin", np.array(accuracy_history))
        save_np_array("../../results/ANN/ann_precision_" + str(c) + ".bin", np.array(precision_history))
        save_np_array("../../results/ANN/ann_recall_" + str(c) + ".bin", np.array(recall_history))
        save_np_array("../../results/ANN/ann_auc_" + str(c) + ".bin", np.array(auc_history))
        save_np_array("../../results/ANN/ann_confusion_matrix_" + str(c) + ".bin", np.array(confusion_matrix_history))
